...
virtuosoPath = "LLMReasoningCert/LLMReasonCert/virtuoso_db/virtuoso-opensource"
...
def start(dbPath, port):
    ...
    print(
        f"{memFree} KB free, using {numberOfBuffers} buffers, {maxDirtyBuffers} dirty buffers"
    )
